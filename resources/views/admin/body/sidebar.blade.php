        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="client">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="{{ route('all.client') }}" class="nav-link">All Clients</a>
                </li>
                <li class="nav-item">
                  <a href="{{ route('new.client') }}" class="nav-link">Add Client</a>
                </li>
                <!--<li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="proposals">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="{{ route('all.proposals') }}" class="nav-link">All Proposals</a>
                </li>
                <li class="nav-item">
                  <a href="{{ route('new.proposal') }}" class="nav-link">Add Proposal</a>
                </li>
                <!--<li class="nav-item">
                  <a href="#" class="nav-link">Schedule</a>
                </li>-->
