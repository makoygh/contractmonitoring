            ...
            <div class="col-12 col-xl-12 stretch-card">
                ...
                <div class="col-md-3 grid-margin stretch-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-6 col-md-12 col-xl-5">
                            <h2 class="mb-2" style="font-size: 50px"><a href="{{ route('new.contracts.report') }}">{{ $contract_count }}</a></h2>
                ...
                <div class="col-md-3 grid-margin stretch-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                        <div class="col-6 col-md-12 col-xl-5">
                            <h3 class="mb-2" style="font-size: 50px"> <a href="{{ route('new.clients.report') }}"> {{ $client_count }} </a> </h3>
                            <div class="d-flex align-items-baseline">
                            <!--<p class="text-danger">
                                <span>-2.8%</span>
                ...
                <div class="col-md-3 grid-margin stretch-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                        <div class="col-6 col-md-12 col-xl-5">
                            <h3 class="mb-2" style="font-size: 50px"><a href="{{ route('all.expire.contracts') }}"> {{ $contract_expire }} </a></h3>
                            <div class="d-flex align-items-baseline">
                           <!-- <p class="text-success">
                                <span>+2.8%</span>
                                <i data-feather="arrow-up" class="icon-sm mb-1"></i>
