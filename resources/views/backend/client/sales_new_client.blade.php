          ...
          <div class="col-md-8 col-xl-8 middle-wrapper">
            ...
            <div class="card">
              <div class="card-body">
								...
								<h6 class="card-title">Add New Client</h6>

								<form class="forms-sample" method="POST" action="{{ route('sales.store.newclient') }}" enctype="multipart/form-data">
                                ...
                                @csrf
									...
									<div class="mb-3">
                                        ...
                                        class="form-control @error('client_address') is-invalid @enderror" id="client_address" autocomplete="off" >
									...
									<div class="mb-3">
                                        ...
                                        class="form-control @error('client_country') is-invalid @enderror" id="client_country" autocomplete="off" >
									...
									<div class="mb-3">
                                        ...
                                        class="form-control @error('client_contactperson') is-invalid @enderror" id="client_contactperson" autocomplete="off" >
