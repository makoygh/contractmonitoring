          ...
          <div class="col-md-8 col-xl-8 middle-wrapper">
            ...
            <div class="card">
              <div class="card-body">
								...
								<form class="forms-sample" method="POST" action="{{ route('sales.save.editcontract') }}" enctype="multipart/form-data">

                                @csrf
                                    <input type="hidden" value="{{ $userData->id}}" name="userid" id="userid">
                                    <input type="hidden" value="{{ $contractData->id}}" name="contract_id" id="contract_id">
                                    <div class="mb-3">
                                       ...
                                       <!-- <input type="text" name="client_name" 
                                        ...
                                        @foreach($clientData as $client)
                                            <option value="{{ $client->id }}" {{$client->id == $contractData->client_id  ? 'selected' : ''}}>{{ $client->client_name}}</option>
                                        @endforeach
                                        </select>
									...
									<div class="mb-3">
                                        ...
                                        class="form-control @error('project_name') is-invalid @enderror" id="project_name" autocomplete="off" value="{{ $contractData->project_name}}" >
                                        @error('project_name')
                                            <span class='text-danger'>{{ $message }}</span>
                                        @enderror
									</div>
									...
									<div class="mb-3">
                                        ...
                                        <input class="form-control mb-4 mb-md-0 @error('contract_start') is-invalid @enderror" id="contract_start" name="contract_start" data-inputmask="'alias': 'datetime'" data-inputmask-inputformat="yyyy-mm-dd" inputmode="numeric" value="{{ $contractData->contract_start}}">
									...
									<div class="mb-3">
                                        ...
                                        <!--<input type="date" name="contract_start" 
                                        class="form-control @error('contract_start') is-invalid @enderror" id="contract_start" autocomplete="off" >-->
                                        <input class="form-control mb-4 mb-md-0 @error('contract_end') is-invalid @enderror" id="contract_end" name="contract_end" data-inputmask="'alias': 'datetime'" data-inputmask-inputformat="yyyy-mm-dd" inputmode="numeric" value="{{ $contractData->contract_end}}" >
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control mb-4 mb-md-0 @error('contract_signed') is-invalid @enderror" id="contract_signed" name="contract_signed" data-inputmask="'alias': 'datetime'" data-inputmask-inputformat="yyyy-mm-dd" inputmode="numeric" value="{{ $contractData->contract_signed}}" >
									...
									<div class="mb-3">
                                        ...
                                        <input class="form-control  @error('contract_filename') is-invalid @enderror" type="file" id="contract_filename" name="contract_filename" value="{{ $contractData->contract_filename}}">
                                    ...
                                    <div class="mb-3">
										...
										<select class="form-select  @error('contract_status') is-invalid @enderror" name="contract_status" id="contract_status">
											...
											<option value="active" {{$contractData->contract_status == 'active'  ? 'selected' : ''}}>active</option>
											<option value="inactive" {{$contractData->contract_status == 'inactive'  ? 'selected' : ''}}>inactive</option>
                                            <option value="on-hold" {{$contractData->contract_status == 'on-hold'  ? 'selected' : ''}}>on-hold</option>
										</select>
                                    ...
                                    <div class="mb-3">
										<label for="createdBy" class="form-label">Updated By</label><br>
