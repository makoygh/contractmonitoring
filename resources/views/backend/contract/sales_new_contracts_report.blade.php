...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">New Contracts Report</li>
    </ol>
...
<div class="card">
<div class="card-body">
<h6 class="card-title">New Contracts Report</h6>
...
<div class="table-responsive">
  <table id="dataTableExample" class="table">
    ...
    <tbody>
    @foreach($newContractsData as $key => $item)
      <tr>
