...
<nav class="page-breadcrumb">
    ...
    <a href="{{ route('sales.new.proposal') }}" class="btn btn-outline-primary">Add New Proposal</a>
</nav>
  ...
  <table id="dataTableExample" class="table">
    ...
    @foreach($allProposals as $key => $item)
      <tr>
        ...
        <td>
        <a href="{{ route('sales.edit.proposal',$item->id) }}" class="btn btn-inverse-warning">Edit</a>
        <a href="{{ route('sales.delete.proposal',$item->id) }}" class="btn btn-inverse-danger" id="delete">Delete</a>    
