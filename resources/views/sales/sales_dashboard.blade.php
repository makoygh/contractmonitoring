...
<head>
  ...
  <meta name="description" content="Responsive HTML Admin Dashboard Template based on Bootstrap 5">
	...
	<title>Sales Panel - Contract Monitoring</title>
...
<body>
	<div class="main-wrapper">
        ...
        @include('sales.body.sales_sidebar')
    <!--
    <nav class="settings-sidebar">
      <div class="sidebar-body">
        ...
        @include('sales.body.sales_header')
			<!-- partial -->
       ...
       @yield('sales')
        ...
        @include('sales.body.sales_footer')
			<!-- partial -->
...
<script>
      ...
      var chart = new ApexCharts(document.querySelector("#generated_proposals_chart"), options);
...
var approval_rate_data = {!! $approval_rate !!}
//alert(approval_rate_data);
//console.log(approval_rate_data);

const appr_rate = [];

appr_rate.push(approval_rate_data);
...
var chart = new ApexCharts(document.querySelector("#approved_proposals_chart"), options);
