            ...
            <div class="card">
              <div class="position-relative">
                <figure class="overflow-hidden mb-0 d-flex justify-content-center">
                  <img src="{{ asset('img/profile_sales.jpg') }}"class="rounded-top" alt="profile cover">
                </figure>
          ...
          <div class="col-md-8 col-xl-8 middle-wrapper">
            ...
            <div class="card">
              <div class="card-body">
								...
								<form class="forms-update-profile" method="POST" action="{{ route('sales.profile.update') }}" enctype="multipart/form-data">
